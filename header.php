...
<?php 
// Check the uri, the part after the http host (/magikerensRejse/etc/);
$url = $_SERVER['REQUEST_URI'];
?>

<!-- golden icons check -->
  <?php 
         if ($url == "/magikerensRejse/") {
                $goldQr = "golden-qr"; 
                $goldBurger = "golden-burger";
              } else if($url == "/magikerensRejse/optagelse/") {
                $goldQr = "golden-qr";
                $goldBurger = "golden-burger";
              }else {
                $goldQr = "";
  ...
  <section class=" <?php echo $bgImg ?> ">
    ...
    <header class="header">
        <!--burgermenu-->
        <div id="nav-icon" class="<?php echo $goldBurger; ?>">
        ...
        <div class="logoHeader">
          <?php if ( function_exists( 'the_custom_logo' ) ) {
              if ($url == "/magikerensRejse/") {
                    ?>
                    <a href="http://localhost/magikerensRejse/">
                        <img class="desktopHeaderLogo custom-logo" src="<?php echo get_stylesheet_directory_uri(); ?>/img/desktopLogo.png" alt="the golden logo">                
                         </a>
